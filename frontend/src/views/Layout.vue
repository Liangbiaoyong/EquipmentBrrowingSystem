...
const allMenus=[{index:'/dashboard',title:'仪表盘',icon:DataAnalysis,perm:'dashboard:view'},{index:'/devices',title:'设备浏览',icon:Monitor,perm:'device:view'},{index:'device-manage',title:'设备管理',icon:Setting,perm:'device:manage',children:[{index:'/devices/manage/list',title:'设备列表'},{index:'/devices/manage/import',title:'批量导入',perm:'device:import'},{index:'/devices/manage/missing-images',title:'缺少图片'},{index:'/devices/manage/categories',title:'分类管理',perm:'category:manage'},{index:'/devices/manage/laboratories',title:'实验室管理',perm:'laboratory:manage'},{index:'/repairs',title:'维修管理',perm:'repair:manage'},{index:'/scrap',title:'报废管理',perm:'repair:manage'}]},{index:'/borrows/create',title:'借用申请',icon:Reading,perm:'borrow:create'},{index:'/borrows/my',title:'我的借用',icon:Reading,perm:'borrow:my'},{index:'approval',title:'借用管理',icon:EditPen,perm:'approval:first',children:[{index:'/borrows/browse',title:'借用浏览',perm:'borrow:view'},{index:'/approvals/first',title:'初审',perm:'approval:first'},{index:'/approvals/second',title:'终审',perm:'approval:second'},{index:'/returns/overdue',title:'逾期管理',perm:'return:manage'},{index:'/returns/approvals',title:'归还审批',perm:'return:manage'}]},{index:'/statistics',title:'数据统计',icon:TrendCharts,perm:'statistics:view'},{index:'/notifications',title:'消息中心',icon:Bell,perm:'notification:view'},{index:'admin',title:'系统管理',icon:Setting,perm:'admin:user',children:[{index:'/admin/users',title:'用户管理'},{index:'/admin/settings',title:'系统设置'},{index:'/admin/logs',title:'操作日志'},{index:'/admin/data-tables',title:'数据表管理'},{index:'/admin/backup',title:'数据备份',perm:'admin:backup'},{index:'/admin/test-data',title:'测试数据',perm:'admin:user'}]}]
